    ...
    return (
        ...
        >
            <div className="text-center">
                <div className="text-light fw-bold fs-5">#{session}</div>
                ...
                <div>
                    ...
                    >
                        <input
                            type="text"
                            id="newTask"
                            className="bg-white text-dark h-100 w-100 rounded-1 p-2 ps-4 form-control fs-5 border-0 "
                        ...
                        <button
                            ...
                            className="btn btn-text-primary px-3 py-2 ms-3 rounded-4 fs-5 fw-bold"
